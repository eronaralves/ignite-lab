          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-4">
              <img 
                ...
                src="https://github.com/eronaralves.png" 
                alt=""
                />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Eronar Alves</strong>
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          ...
          <a href="" className="bg-gray-700 roundend overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
            ...
            <div className=" py-[23px]">
              <h3 className="text-2xl text-gray-100 font-bold ">Material complementar</h3>
